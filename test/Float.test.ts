...
const compare = (
  int: IntegerType | RationalType | FloatType,
  res: string,
  radix = 10
) => {
...
test("lessThan()", () => {
  ...
  const binaryCtx = init(instance, { radix: 2 });
...
test("asin()", () => {
  ...
  compare(
    ctx.Float(ctx.Float(1).div(2)).asin(),
    ctx.Pi().div(6).toString(10, true)
  );
  compare(
    ctx.Float(ctx.Float(2).sqrt().div(2)).asin(),
    ctx.Pi().div(4).toString(10, true)
  );
  compare(
    ctx.Float(ctx.Float(3).sqrt().div(2)).asin(),
    ctx.Pi().div(3).toString(10, true)
  );
...
test("acos()", () => {
  ...
  compare(
    ctx.Float(ctx.Float(1).div(2)).acos(),
    ctx.Pi().div(3).toString(10, true)
  );
  compare(
    ctx.Float(ctx.Float(2).sqrt().div(2)).acos(),
    ctx.Pi().div(4).toString(10, true)
  );
...
test("atan()", () => {
  ...
  compare(
    ctx.Float(ctx.Float(3).sqrt()).atan(),
    ctx.Pi().div(3).toString(10, true)
  );
});
...
test("csc()", () => {
  compare(
    ctx.Float(ctx.Pi().div(3)).csc(),
    ctx.Float(3).sqrt().mul(2).div(3).toString(10, true)
  );
});
...
test("toString()", () => {
  expect(ctx.Float("1".repeat(8000), { precisionBits: 32000 }).toString()).toBe(
    "1".repeat(8000)
  );
});
...
//   expect(gmp.calculate((g) => g.Float(1).div(3), {})).toBe(
//     "0.33333333333333331"
//   );
//   expect(gmp.calculate((g) => g.Float(1, {}).div(3))).toBe(
//     "0.33333333333333331"
...
//   expect(gmp.calculate((g) => g.Float(1, options).div(3), {})).toBe("0.333");
//   // merge precision
//   expect(gmp.calculate((g) => g.Float(1).div(g.Float(3)), options)).toBe(
//     "0.333"
//   );
//   expect(
//     gmp.calculate(
//       (g) =>
//         g.Float(1, { precisionBits: 5 }).div(g.Float(3, { precisionBits: 15 })),
//       options
//     )
//   ).toBe("0.333328");
//   expect(
//     gmp.calculate(
//       (g) =>
//         g.Float(1, { precisionBits: 15 }).div(g.Float(3, { precisionBits: 5 })),
//       options
//     )
//   ).toBe("0.333328");
//   expect(
//     gmp.calculate(
//       (g) =>
//         g.Float(1, { precisionBits: 4 }).div(g.Float(3, { precisionBits: 5 })),
//       options
//     )
//   ).toBe("0.328");
//   // merge roundingMode
...
//   expect(
//     gmp.calculate(
//       (g) => g.Float(1, { roundingMode: ROUND_UP }).div(g.Float(3)),
//       options
//     )
//   ).toBe("0.33349");
//   expect(
//     gmp.calculate(
//       (g) => g.Float(1).div(g.Float(3, { roundingMode: ROUND_UP })),
//       options
//     )
//   ).toBe("0.33301");
//   // merge radix
//   expect(gmp.calculate((g) => g.Float("3", { radix: 4 }).div("21"), {})).toBe(
//     "0.111111111111111111111111111"
//   );
//   expect(gmp.calculate((g) => g.Float("3").div("21"), { radix: 4 })).toBe(
//     "0.111111111111111111111111111"
//   );
//   expect(
//     gmp.calculate((g) => g.Float("3").div(g.Float("21", { radix: 4 })), {})
//   ).toBe("0.111111111111111111111111111");
// });
