...
test("writeTo()", () => {
  ...
  compare(
    ctx.Integer(0x12345678).writeTo(ctx.Integer(0xff), 12),
    "123ff678",
    16
  );
  compare(
    ctx.Integer(0x12345678).writeTo(ctx.Integer(0xff), 12, 4),
    "1234f678",
    16
  );
  compare(
    ctx.Integer(0x12345678).writeTo(ctx.Integer(0xff), 12, 16),
    "100ff678",
    16
  );
});
...
//   expect(ctx.Integer("256").toBuffer(true)).toStrictEqual(
//     new Uint8Array([0, 1])
//   );
//   expect(ctx.Integer("1234567").toBuffer()).toStrictEqual(
//     new Uint8Array([0b10010, 0b11010110, 0b10000111])
//   );
//   expect(ctx.Integer("1234567").toBuffer(true)).toStrictEqual(
//     new Uint8Array([0b10000111, 0b11010110, 0b10010])
//   );
// });
