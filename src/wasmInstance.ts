...
export type WasmInstance = Awaited<ReturnType<typeof createWasmInstance>>;

export const createWasmInstance = async (module: Response) => {
  ...
  const { instance } = await WebAssembly.instantiateStreaming(module, {
    env: {
      emscripten_notify_memory_growth: () => {
        heap.HEAP8 = new Uint8Array((gmp as any).memory.buffer);
      },
    },
  ...
  const gmp: any = instance.exports;
  gmp._initialize();
  ...
  const getStringPointer = (input: string) => {
    ...
    heap.HEAP8.set(data, srcPtr);
    heap.HEAP8[srcPtr + data.length] = 0;
    return srcPtr;
  };
  ...
  const out = {
    ...
    malloc_cstr: (str: string): number => {
      ...
      heap.HEAP8.set(buf, ptr);
      heap.HEAP8[ptr + buf.length] = 0;
      return ptr;
    },
    ...
    ): c_unsigned_long_int => gmp.z_cdiv_q_ui(q, n, d),
    ...
    mpz_cdiv_qr_ui: (
      ...
      n: mpz_srcptr,
      d: c_unsigned_long_int
    ): c_unsigned_long_int => gmp.z_cdiv_qr_ui(q, r, n, d),
    ...
    mpz_cdiv_r_ui: (
      ...
      n: mpz_srcptr,
      d: c_unsigned_long_int
    ): c_unsigned_long_int => gmp.z_cdiv_r_ui(r, n, d),
    ...
    mpz_congruent_p: (n: mpz_srcptr, c: mpz_srcptr, d: mpz_srcptr): c_int =>
      gmp.z_congruent_p(n, c, d),
    /** Return non-zero if n is congruent to c modulo 2^b. */
    mpz_congruent_2exp_p: (
      n: mpz_srcptr,
      c: mpz_srcptr,
      b: mp_bitcnt_t
    ): c_int => gmp.z_congruent_2exp_p(n, c, b),
    /** Return non-zero if n is congruent to c modulo d. */
    mpz_congruent_ui_p: (
      n: mpz_srcptr,
      c: c_unsigned_long_int,
      d: c_unsigned_long_int
    ): c_int => gmp.z_congruent_ui_p(n, c, d),
    ...
    mpz_export: (
      ...
      nails: c_size_t,
      op: mpz_srcptr
    ): c_void_ptr => gmp.z_export(rop, countp, order, size, endian, nails, op),
    ...
    mpz_fdiv_q_ui: (
      ...
      n: mpz_srcptr,
      d: c_unsigned_long_int
    ): c_unsigned_long_int => gmp.z_fdiv_q_ui(q, n, d),
    ...
    mpz_fdiv_qr_ui: (
      ...
      n: mpz_srcptr,
      d: c_unsigned_long_int
    ): c_unsigned_long_int => gmp.z_fdiv_qr_ui(q, r, n, d),
    ...
    mpz_fdiv_r_ui: (
      ...
      n: mpz_srcptr,
      d: c_unsigned_long_int
    ): c_unsigned_long_int => gmp.z_fdiv_r_ui(r, n, d),
    ...
    mpz_gcd_ui: (
      ...
      op1: mpz_srcptr,
      op2: c_unsigned_long_int
    ): c_unsigned_long_int => gmp.z_gcd_ui(rop, op1, op2),
    ...
    mpz_init_set_str: (rop: mpz_ptr, str: c_str_ptr, base: c_int): c_int =>
      gmp.z_init_set_str(rop, str, base),
    /** Initialize rop with limb space and set the initial numeric value from op. */
    ...
    mpz_tdiv_q_ui: (
      ...
      n: mpz_srcptr,
      d: c_unsigned_long_int
    ): c_unsigned_long_int => gmp.z_tdiv_q_ui(q, n, d),
    ...
    mpq_cmp_si: (
      op1: mpq_srcptr,
      num2: c_signed_long_int,
      den2: c_unsigned_long_int
    ): c_int => gmp.q_cmp_si(op1, num2, den2),
    /** Compare op1 and num2 / den2. */
    mpq_cmp_ui: (
      op1: mpq_srcptr,
      num2: c_unsigned_long_int,
      den2: c_unsigned_long_int
    ): c_int => gmp.q_cmp_ui(op1, num2, den2),
    /** Compare op1 and op2. */
    ...
    mpfr_get_default_rounding_mode: (): mpfr_rnd_t =>
      gmp.r_get_default_rounding_mode(),
    ...
    mpfr_can_round: (
      ...
      rnd2: mpfr_rnd_t,
      prec: mpfr_prec_t
    ): c_int => gmp.r_can_round(b, err, rnd1, rnd2, prec),
    ...
    mpfr_set_z_2exp: (
      ...
      e: mpfr_exp_t,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_set_z_2exp(rop, op, e, rnd),
    ...
    mpfr_set_si: (
      ...
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_set_si(rop, op, rnd),
    /** Set the value of rop from op rounded toward the given direction rnd. */
    mpfr_set_ui: (
      rop: mpfr_ptr,
      op: c_unsigned_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_set_ui(rop, op, rnd),
    /** Set the value of rop from op multiplied by two to the power e, rounded toward the given direction rnd. */
    mpfr_set_si_2exp: (
      rop: mpfr_ptr,
      op: c_signed_long_int,
      e: mpfr_exp_t,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_set_si_2exp(rop, op, e, rnd),
    /** Set the value of rop from op multiplied by two to the power e, rounded toward the given direction rnd. */
    mpfr_set_ui_2exp: (
      rop: mpfr_ptr,
      op: c_unsigned_long_int,
      e: mpfr_exp_t,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_set_ui_2exp(rop, op, e, rnd),
    /** Set the value of rop from op rounded toward the given direction rnd. */
    mpfr_set_q: (rop: mpfr_ptr, op: mpq_srcptr, rnd: mpfr_rnd_t): c_int =>
      gmp.r_set_q(rop, op, rnd),
    ...
    mpfr_mul_q: (
      ...
      op2: mpq_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_mul_q(rop, op1, op2, rnd),
    /** Set rop to op1 / op2 rounded in the direction rnd. */
    mpfr_div_q: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: mpq_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_div_q(rop, op1, op2, rnd),
    /** Set rop to op1 + op2 rounded in the direction rnd. */
    mpfr_add_q: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: mpq_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_add_q(rop, op1, op2, rnd),
    /** Set rop to op1 - op2 rounded in the direction rnd. */
    mpfr_sub_q: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: mpq_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_sub_q(rop, op1, op2, rnd),
    /** Compare op1 and op2. */
    ...
    mpfr_set_str: (
      ...
      base: c_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_set_str(rop, s, base, rnd),
    /** Initialize rop and set its value from op, rounded in the direction rnd. */
    mpfr_init_set: (rop: mpfr_ptr, op: mpfr_srcptr, rnd: mpfr_rnd_t) =>
      gmp.r_init_set(rop, op, rnd),
    /** Initialize rop and set its value from op, rounded in the direction rnd. */
    mpfr_init_set_ui: (rop: mpfr_ptr, op: number, rnd: mpfr_rnd_t) =>
      gmp.r_init_set_ui(rop, op, rnd),
    /** Initialize rop and set its value from op, rounded in the direction rnd. */
    mpfr_init_set_si: (rop: mpfr_ptr, op: number, rnd: mpfr_rnd_t) =>
      gmp.r_init_set_si(rop, op, rnd),
    /** Initialize rop and set its value from op, rounded in the direction rnd. */
    mpfr_init_set_d: (rop: mpfr_ptr, op: number, rnd: mpfr_rnd_t) =>
      gmp.r_init_set_d(rop, op, rnd),
    /** Initialize rop and set its value from op, rounded in the direction rnd. */
    mpfr_init_set_z: (rop: mpfr_ptr, op: mpz_srcptr, rnd: mpfr_rnd_t) =>
      gmp.r_init_set_z(rop, op, rnd),
    /** Initialize rop and set its value from op, rounded in the direction rnd. */
    mpfr_init_set_q: (rop: mpfr_ptr, op: mpq_srcptr, rnd: mpfr_rnd_t) =>
      gmp.r_init_set_q(rop, op, rnd),
    ...
    mpfr_init_set_str: (
      ...
      base: c_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_init_set_str(x, s, base, rnd),
    ...
    mpfr_setsign: (
      ...
      s: c_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_setsign(rop, op, s, rnd),
    ...
    mpfr_copysign: (
      ...
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_copysign(rop, op1, op2, rnd),
    ...
    mpfr_get_d_2exp: (
      ...
      op: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_double => gmp.r_get_d_2exp(exp, op, rnd),
    ...
    mpfr_pow: (
      ...
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_pow(rop, op1, op2, rnd),
    /** Set rop to op1 raised to op2, rounded in the direction rnd. */
    mpfr_pow_si: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_signed_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_pow_si(rop, op1, op2, rnd),
    /** Set rop to op1 raised to op2, rounded in the direction rnd. */
    mpfr_pow_ui: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_unsigned_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_pow_ui(rop, op1, op2, rnd),
    /** Set rop to op1 raised to op2, rounded in the direction rnd. */
    mpfr_ui_pow_ui: (
      rop: mpfr_ptr,
      op1: c_unsigned_long_int,
      op2: c_unsigned_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_ui_pow_ui(rop, op1, op2, rnd),
    /** Set rop to op1 raised to op2, rounded in the direction rnd. */
    mpfr_ui_pow: (
      rop: mpfr_ptr,
      op1: c_unsigned_long_int,
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_ui_pow(rop, op1, op2, rnd),
    /** Set rop to op1 raised to op2, rounded in the direction rnd. */
    mpfr_pow_z: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
    ...
    mpfr_add: (
      ...
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_add(rop, op1, op2, rnd),
    /** Set rop to op1 - op2 rounded in the direction rnd. */
    mpfr_sub: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_sub(rop, op1, op2, rnd),
    /** Set rop to op1 * op2 rounded in the direction rnd. */
    mpfr_mul: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_mul(rop, op1, op2, rnd),
    /** Set rop to op1 / op2 rounded in the direction rnd. */
    mpfr_div: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_div(rop, op1, op2, rnd),
    /** Set rop to op1 + op2 rounded in the direction rnd. */
    mpfr_add_ui: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_unsigned_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_add_ui(rop, op1, op2, rnd),
    /** Set rop to op1 - op2 rounded in the direction rnd. */
    mpfr_sub_ui: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_unsigned_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_sub_ui(rop, op1, op2, rnd),
    /** Set rop to op1 - op2 rounded in the direction rnd. */
    mpfr_ui_sub: (
      rop: mpfr_ptr,
      op1: c_unsigned_long_int,
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_ui_sub(rop, op1, op2, rnd),
    /** Set rop to op1 * op2 rounded in the direction rnd. */
    mpfr_mul_ui: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_unsigned_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_mul_ui(rop, op1, op2, rnd),
    /** Set rop to op1 / op2 rounded in the direction rnd. */
    mpfr_div_ui: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_unsigned_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_div_ui(rop, op1, op2, rnd),
    /** Set rop to op1 / op2 rounded in the direction rnd. */
    mpfr_ui_div: (
      rop: mpfr_ptr,
      op1: c_unsigned_long_int,
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_ui_div(rop, op1, op2, rnd),
    /** Set rop to op1 + op2 rounded in the direction rnd. */
    mpfr_add_si: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_signed_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_add_si(rop, op1, op2, rnd),
    /** Set rop to op1 - op2 rounded in the direction rnd. */
    mpfr_sub_si: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_signed_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_sub_si(rop, op1, op2, rnd),
    /** Set rop to op1 - op2 rounded in the direction rnd. */
    mpfr_si_sub: (
      rop: mpfr_ptr,
      op1: c_signed_long_int,
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_si_sub(rop, op1, op2, rnd),
    /** Set rop to op1 * op2 rounded in the direction rnd. */
    mpfr_mul_si: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_signed_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_mul_si(rop, op1, op2, rnd),
    /** Set rop to op1 / op2 rounded in the direction rnd. */
    mpfr_div_si: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_signed_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_div_si(rop, op1, op2, rnd),
    /** Set rop to op1 / op2 rounded in the direction rnd. */
    mpfr_si_div: (
      rop: mpfr_ptr,
      op1: c_signed_long_int,
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_si_div(rop, op1, op2, rnd),
    /** Set rop to op1 + op2 rounded in the direction rnd. */
    mpfr_add_d: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_double,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_add_d(rop, op1, op2, rnd),
    /** Set rop to op1 - op2 rounded in the direction rnd. */
    mpfr_sub_d: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_double,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_sub_d(rop, op1, op2, rnd),
    /** Set rop to op1 - op2 rounded in the direction rnd. */
    mpfr_d_sub: (
      rop: mpfr_ptr,
      op1: c_double,
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_d_sub(rop, op1, op2, rnd),
    /** Set rop to op1 * op2 rounded in the direction rnd. */
    mpfr_mul_d: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_double,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_mul_d(rop, op1, op2, rnd),
    /** Set rop to op1 / op2 rounded in the direction rnd. */
    mpfr_div_d: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_double,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_div_d(rop, op1, op2, rnd),
    /** Set rop to op1 / op2 rounded in the direction rnd. */
    mpfr_d_div: (
      rop: mpfr_ptr,
      op1: c_double,
    ...
    mpfr_agm: (
      ...
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_agm(rop, op1, op2, rnd),
    ...
    mpfr_eq: (
      op1: mpfr_srcptr,
      op2: mpfr_srcptr,
      op3: c_unsigned_long_int
    ): c_int => gmp.r_eq(op1, op2, op3),
    ...
    mpfr_mul_2exp: (
      ...
      op2: c_unsigned_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_mul_2exp(rop, op1, op2, rnd),
    ...
    mpfr_div_2exp: (
      ...
      op2: c_unsigned_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_div_2exp(rop, op1, op2, rnd),
    /** Set rop to op1 * 2^op2 rounded in the direction rnd. */
    mpfr_mul_2ui: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_unsigned_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_mul_2ui(rop, op1, op2, rnd),
    /** Set rop to op1 divided by 2^op2 rounded in the direction rnd. */
    mpfr_div_2ui: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_unsigned_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_div_2ui(rop, op1, op2, rnd),
    /** Set rop to op1 * 2^op2 rounded in the direction rnd. */
    mpfr_mul_2si: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_signed_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_mul_2si(rop, op1, op2, rnd),
    /** Set rop to op1 divided by 2^op2 rounded in the direction rnd. */
    mpfr_div_2si: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: c_signed_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_div_2si(rop, op1, op2, rnd),
    ...
    mpfr_rint_roundeven: (
      ...
      op: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_rint_roundeven(rop, op, rnd),
    ...
    mpfr_modf: (
      ...
      op: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_modf(rop, fop, op, rnd),
    ...
    mpfr_remquo: (
      ...
      y: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_remquo(r, q, x, y, rnd),
    /** Set r to the value of x - n * y, rounded according to the direction rnd, where n is the integer quotient of x divided by y, rounded to the nearest integer (ties rounded to even). */
    mpfr_remainder: (
      rop: mpfr_ptr,
      x: mpfr_srcptr,
      y: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_remainder(rop, x, y, rnd),
    ...
    mpfr_fmodquo: (
      ...
      y: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_fmodquo(rop, q, x, y, rnd),
    ...
    mpfr_sinh_cosh: (
      ...
      op: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_sinh_cosh(sop, cop, op, rnd),
    ...
    mpfr_rootn_ui: (
      ...
      k: c_unsigned_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_rootn_ui(rop, op, k, rnd),
    ...
    mpfr_gamma_inc: (
      ...
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_gamma_inc(rop, op, op2, rnd),
    ...
    mpfr_beta: (
      ...
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_beta(rop, op1, op2, rnd),
    ...
    mpfr_lgamma: (
      ...
      op: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_lgamma(rop, signp, op, rnd),
    ...
    mpfr_zeta: (rop: mpfr_ptr, op: mpfr_srcptr, rnd: mpfr_rnd_t): c_int =>
      gmp.r_zeta(rop, op, rnd),
    /** Set rop to the value of the Riemann Zeta function on op rounded in the direction rnd. */
    mpfr_zeta_ui: (
      rop: mpfr_ptr,
      op: c_unsigned_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_zeta_ui(rop, op, rnd),
    /** Set rop to the factorial of op rounded in the direction rnd. */
    mpfr_fac_ui: (
      rop: mpfr_ptr,
      op: c_unsigned_long_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_fac_ui(rop, op, rnd),
    ...
    mpfr_min: (
      ...
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_min(rop, op1, op2, rnd),
    ...
    mpfr_max: (
      ...
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_max(rop, op1, op2, rnd),
    ...
    mpfr_dim: (
      ...
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_dim(rop, op1, op2, rnd),
    /** Set rop to op1 * op2 rounded in the direction rnd. */
    mpfr_mul_z: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: mpz_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_mul_z(rop, op1, op2, rnd),
    /** Set rop to op1 / op2 rounded in the direction rnd. */
    mpfr_div_z: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: mpz_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_div_z(rop, op1, op2, rnd),
    /** Set rop to op1 + op2 rounded in the direction rnd. */
    mpfr_add_z: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: mpz_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_add_z(rop, op1, op2, rnd),
    /** Set rop to op1 - op2 rounded in the direction rnd. */
    mpfr_sub_z: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      op2: mpz_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_sub_z(rop, op1, op2, rnd),
    /** Set rop to op1 - op2 rounded in the direction rnd. */
    mpfr_z_sub: (
      rop: mpfr_ptr,
      op1: mpz_srcptr,
      op2: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_z_sub(rop, op1, op2, rnd),
    /** Compare op1 and op2. */
    ...
    mpfr_fma: (
      ...
      op3: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_fma(rop, op1, op2, op3, rnd),
    /** Set rop to (op1 * op2) - op3 rounded in the direction rnd. */
    mpfr_fms: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      ...
      op3: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_fms(rop, op1, op2, op3, rnd),
    ...
    mpfr_fmma: (
      ...
      op4: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_fmma(rop, op1, op2, op3, op4, rnd),
    /** Set rop to (op1 * op2) - (op3 * op4) rounded in the direction rnd. */
    mpfr_fmms: (
      rop: mpfr_ptr,
      op1: mpfr_srcptr,
      ...
      op4: mpfr_srcptr,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_fmms(rop, op1, op2, op3, op4, rnd),
    ...
    mpfr_strtofr: (
      ...
      base: c_int,
      rnd: mpfr_rnd_t
    ): c_int => gmp.r_strtofr(rop, nptr, endptr, base, rnd),
    ...
    mpz_to_string(x: mpz_ptr, base: number): string {
      ...
      const endPtr = heap.HEAP8.indexOf(0, strPtr);
      const str = decoder.decode(heap.HEAP8.subarray(strPtr, endPtr));
      if (destPtr !== strBuf) {
        gmp.g_free(strPtr);
      }
      return str;
    ...
    mpq_to_string(x: mpz_ptr, base: number): string {
      let destPtr = 0;
      const requiredSize =
        gmp.z_sizeinbase(gmp.q_numref(x), base) +
        gmp.z_sizeinbase(gmp.q_denref(x), base) +
        3;
    ...
    mpfr_to_string(
      ...
      const strPtr = gmp.r_get_str(
        ...
        n,
        x,
        truncate ? mpfr_rnd_t.MPFR_RNDZ : rnd
      );
      const endPtr = heap.HEAP8.indexOf(0, strPtr);
      let str = decoder.decode(heap.HEAP8.subarray(strPtr, endPtr));
